			...
			<div class="left-content">
				...
				<div class="grid-form">
					...
					<div class="grid-form1">
						<h3>Kemaskini gambar aktiviti </h3>
						<!--  -->
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="activity" method="post" enctype="multipart/form-data">
									<?php
									$aimage = intval($_GET['aimage']);
									$sql = "SELECT activityImage from activity where activityId=:aimage";
									$query = $dbh->prepare($sql);
									$query->bindParam(':aimage', $aimage, PDO::PARAM_STR);
									$query->execute();
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) { ?>
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Gambar baru</label>
												<div class="col-sm-8">
