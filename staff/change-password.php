	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Utama</a><i class="fa fa-angle-right"></i>Tukar kata
						laluan</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
									...
									<div class="col-md-8">
										<div class="input-group">
											...
											<input type="password" class="form-control1" name="newpassword" id="newpassword"
												placeholder="Kata laluan baharu" required="">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group">
											...
											<input type="password" class="form-control1" name="confirmpassword"
												id="confirmpassword" placeholder="Pastikan kata laluan" required="">
										</div>
									</div>
								</div>
