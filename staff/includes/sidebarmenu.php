<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Aktiviti</span>
					<span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="create-activity.php">Tambah aktiviti</a></li>
					<li id="menu-academico-avaliacoes"><a href="manage-activity.php">Urus aktiviti</a></li>
