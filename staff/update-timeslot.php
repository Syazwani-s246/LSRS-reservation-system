...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$pimage = $_FILES["activityImage"]["name"];
	...
	<head>
		<title>Lambo Sari | Pengurusan Aktiviti</title>
								...
								if ($query->rowCount() > 0) {
									foreach ($results as $result) { ?>
										<form class="form-horizontal" name="activity" method="post" enctype="multipart/form-data">
											...
											<!-- for timeSlot if I want to add later, add here--<div class="form-group">
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Activity Price in
													RM</label>
												<div class="col-sm-8">
													<input type="number" class="form-control1" name="activityPrice"
														id="activityPrice" placeholder=" Activity Price in RM"
														value="<?php echo htmlentities($result->activityPrice); ?>" required>
												</div>
											</div>
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Activity Details</label>
												<div class="col-sm-8">
													<textarea class="form-control" rows="5" cols="50" name="activityDetails"
														id="activityDetails" placeholder="Activity Details"
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<img src="activityImage/<?php echo htmlentities($result->activityImage); ?>"
														width="200">&nbsp;&nbsp;&nbsp;<a
														href="change-image.php?imgid=<?php echo htmlentities($result->activityId); ?>">Change
														Image</a>
