...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['submit6'])) {
		...
		$sql = "update customers set fullName=:name,mobileNumber=:mobileno where emailId=:email";
						...
						if ($query->rowCount() > 0) {
							foreach ($results as $result) { ?>
								...
								<p style="width: 350px;">
									...
									<b>Nama penuh</b> <input type="text" name="name"
								...
								<p style="width: 350px;">
									<b>Nombor telefon</b>
									<input type="number" class="form-control" name="mobileno" maxlength="10"
								...
								<p style="width: 350px;">
									<b>Tarikh akhir kemaskini: </b>
									<?php echo htmlentities($result->updationDate); ?>
								</p>

								<p style="width: 350px;">
									<b>Tarikh pendaftaran :</b>
